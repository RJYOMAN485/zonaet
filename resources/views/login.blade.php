                    ...
                    <div class="card justify-content-center align-items-center" style="padding-bottom:500px;">
                        ...
                        <div class="card-body col-md-4 col-sm-6" style="box-shadow: 0 3px 1px -2px rgb(0 0 0 / 20%), 0 2px 2px 0 rgb(0 0 0 / 14%), 0 1px 5px 0 rgb(0 0 0 / 12%);">
                           ...
                           <div style="display: flex;">
                            ...
                            <a href="{{route('auth.register')}}" style="border:thin solid;" class="btn btn-danger">Register</a>
                                ...
                                <a href="{{route('zonet.index')}}" style="border:thin solid;color:white;background-color: #272727; border-radius:4px;" class="btn btn-danger">Cancel</a>

                           </div>

                           <div class="text-center" style="color: rgba(0,0,0,.6);">
                               OR LOGIN WITH GOOGLE
                           </div>

                           {{-- <div class="col text-center mt-2 justify-content-center align-items-center">
                                <a style="background-color: #c62828!important;" href="{{ route('auth.facebook') }}" class="btn btn-raised btn-danger">
                                    <i class="fa fa-google" style="font-size: 30px;" aria-hidden="true"></i>
                                    Login With Facebook
                                </a> 
                            </div> --}}

                            <div class="col text-center mt-2 justify-content-center align-items-center">
                                <a style="background-color: #c62828!important;" href="{{ url('auth/google') }}" class="btn btn-raised btn-danger">
                                    <i class="fa fa-google" style="font-size: 30px;" aria-hidden="true"></i>
                                     Login With Google
                                </a> 
                            </div>
