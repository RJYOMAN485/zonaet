...
<form action="{{url('/payment-complete')}}" method="POST" hidden>
  ...
  <input type="text" class="form-control" value="{{$response['duration']}}" id="duration" name="duration">
  <input type="text" class="form-control" value="{{$response['interval']}}" id="interval" name="interval">
