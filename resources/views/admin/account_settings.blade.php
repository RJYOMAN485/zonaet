...
@section('content')
  ...
  <div class="card">
    <div class="card-body">
      ...
      <form action="{{route('auth.update.admin')}}" method="post">
        @csrf
        <div class="form-group">
          <label for="name">Name</label>
          <input type="text"  value="{{$admin->name}}" class="form-control" name="name" id="name">
        ...
        <div class="form-group">
          ...
          <input type="text" value="{{$admin->email}}" class="form-control" name="email" id="email">
        ...
        <button type="submit" class="btn btn-raised btn-danger" name="submit">Save</button>
      </form>
